...
def main(infile='FAS_log.txt', motif_len_=2, repetition_=4, write_to_log='yes', logfile='results_b.txt'):
	...
	if write_to_log == 'yes':
		...
		#exit
		sys.exit('>>>program ran succesfully and its output has been written in results_b.txt')
	else:
		pass
